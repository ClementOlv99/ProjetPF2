module Data : sig val dt : float val gravity : float end
module Box :
  sig
    val marge : float
    val infx : float
...
module BalleInit : sig val radius : float end
module TabBriquesInit : sig val score : int val nbBrique : int end
